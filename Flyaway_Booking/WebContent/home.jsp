...
<div class="navbar navbar-inverse navbar-fixed-left">
  ...
  <ul class="nav navbar-nav" >
    <li class="activeNav"><a href="/Flyaway_Booking/home.jsp">Home</a></li>

    <li class=""><a href="/Flyaway_Booking/AvailableFlights">All Flights</a></li>
  ...
  <div class="table-wrapper">
    ...
    <div class="row ">
      <div class="col">
        <h1>
          <c:if test="${!empty sessionScope.username}">
            ${sessionScope.username} welcome to FlyAway :)
          </c:if>
        </h1>
      </div>
    </div>
